            ...
            <main class="content__main">
                ...
                <div class="tasks-controls">
                    ...
                    <label class="checkbox">
                        ...
                        <input class="checkbox__input visually-hidden show_completed" type="checkbox" <?php if ($show_complete_tasks == 1 && is_int($show_complete_tasks)): ?>checked<?php endif; ?>>
                ...
                <table class="tasks">
                    ...
                    <?php if ($show_complete_tasks == 1 && is_int($show_complete_tasks)): ?>
